package com.homework12version2;
...
public class MainClass {
    public static void main(String[] args) {
        ArrayList<com.homework12.Figure> figureList = new ArrayList<>();
        ...
        while (answer.equals("YES")) {
            ...
            com.homework12.Figure figure = switch (figureNumber) {
            ...
            Comparator<Figure> figureComparator = new Comparator<Figure>() {
                @Override
